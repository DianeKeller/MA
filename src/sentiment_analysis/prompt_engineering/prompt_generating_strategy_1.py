...
class PromptGeneratingStrategy1(PromptGeneratingStrategy):
    """
    ...
    def define_prompt_part_generation_patterns(self) \
            -> None:
        self._patterns['thought'] = [
            (self.ING, 'thought')
        ]

        self._patterns['before_sentence'] = [
            (self.ING, 'politeness'),
            (self.ING, 'task'),
            (self.ING, 'what'),
            (self.ING, 'given'),
            ...
            (self.ING, 'target'),
            (self.STR, '. \n'),
            (self.ING, 'sentence_label'),
            (self.ING, 'where'),
            (self.CMD, 'rstrip()'),
            (self.STR, ': ')
        ]

        self._patterns['before_mention'] = [
            (self.STR, '\n'),
            (self.ING, 'target'),
            (self.STR, ': ')
        ]

        self._patterns['scale'] = [
            (self.ING, 'scale'),
            (self.CMD, 'replace("{what}", what.strip().replace("the ", ""))'),
        ]

        self._patterns['question'] = [
            (self.STR, 'what is '),
            (self.ING, 'what'),
            (self.ING, 'toward'),
            (self.ING, 'given'),
        ...
        self._patterns['answer_before_mention'] = [
            (self.STR, '\nYour answer: '),
            (self.ING, 'thought'),
            (self.ING, 'what'),
            (self.ING, 'toward')
        ...
        self._patterns['answer_start'] = [
            (self.ING, 'answer_start')
        ]
